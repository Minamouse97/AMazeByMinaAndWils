package edu.wm.cs.cs301.amazebyminaandwils.generation;
        ...
        import edu.wm.cs.cs301.amazebyminaandwils.falstad.Constants;
        import edu.wm.cs.cs301.amazebyminaandwils.ui.DataHolder;
        import edu.wm.cs.cs301.amazebyminaandwils.ui.GeneratingActivity;
...
public class MazeBuilder implements Runnable {
    ...
    private static final String TAG = ":MazeBuilderLOG:";
    ...
    public void run() {
        ...
        Log.v(TAG, "mazebuilder \"run\" method called");
        try {
...
//            GeneratingActivity.finGen();
            order.deliver(mazeConfig);
            System.out.println("is mazeConfig Builder null?... " + mazeConfig);
