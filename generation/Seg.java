...
/**
 * Created by wilsmccreight on 12/2/17.
 */
...
//import java.awt.Color;
        ...
        import edu.wm.cs.cs301.amazebyminaandwils.falstad.MazeFileWriter;
...
//    MazePanel mp = PlayActivity.mp;
//    mp = (MazePanel)findViewById(R.id.button12);

    MazePanel mp;
    private static Context context;
    private static final String TAG = "SegLOG";
...
//        mp = new MazePanel(Context.);
//        Seg.context = getApplicationContext();
//        mp = new MazePanel(Seg.context);
...
//        mp.drawTestFigure();
        ...
        switch (((d >> 3) ^ cc) % 6) {
            case 0:
//                setColor(mp.setColorUsingInts(rgbValue, RGB_DEF, RGB_DEF));
                setColor(Color.rgb(rgbValue, RGB_DEF, RGB_DEF));
                break;
            case 1:
//                setColor(mp.setColorUsingInts(RGB_DEF, rgbValue, RGB_DEF));
                setColor(Color.rgb(RGB_DEF, rgbValue, RGB_DEF));
                break;
            case 2:
//                setColor(mp.setColorUsingInts(RGB_DEF, RGB_DEF, rgbValue));
                setColor(Color.rgb(RGB_DEF, RGB_DEF, rgbValue));
                break;
            case 3:
//                setColor(mp.setColorUsingInts(rgbValue, rgbValue, RGB_DEF));
                setColor(Color.rgb(rgbValue, rgbValue, RGB_DEF));
                break;
            case 4:
//                setColor(mp.setColorUsingInts(RGB_DEF, rgbValue, rgbValue));
                setColor(Color.rgb(RGB_DEF, rgbValue, rgbValue));
                break;
            case 5:
//                setColor(mp.setColorUsingInts(rgbValue, RGB_DEF, rgbValue));
                setColor(Color.rgb(rgbValue, RGB_DEF, rgbValue));
                break;
            default:
//                setColor(mp.setColorUsingInts(RGB_DEF, RGB_DEF, RGB_DEF));
...
//                mp.getRGB());
    ...
    public boolean equals(final Object other) {
        ...
        Log.v(TAG, "seg equals method reached");
        if (this == other) {
            return true;
        }
        if (null == other) {
...
//                || (col.getRGB() != o.col.getRGB())) {
     ...
     * @return the color
     */
    public /*Color*/ /*Object*/ int getColor() {
//        Log.v(TAG, "seg \"getColor\" reached, col is equal to: " + col);
        return col;
    }
     ...
     *            the color to set
     */
    public void setColor(/*final Col
    or color*/ /*Object*/ int color) {
        /*
         ...
         */
        col = color;
//        col = mp.setColorUsingInt(a, b, c);
//        mp.setColorUsingInt(a, b, c);
    }
