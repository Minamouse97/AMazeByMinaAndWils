...
//		MazePanel mp;
    ...
    private BSPNode readBSPNode(Element eElement) {
        ...
        if (isleafLoad)
        {
            ...
            for (int i = 0 ; i < n ; i++)
            {
                slist.add(readSegment(eElement, number, i, mp)) ;
            }
     ...
     */
    private static Seg readSegment(Element eElement, int number, int i, MazePanel mp) {
...
//		MazePanel mp;
        result.setColor(mp.setColorUsingInt(col));
