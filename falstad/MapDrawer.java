...
public class MapDrawer extends DefaultViewer {
    ...
    public void draw_map(MazePanel mp, int px, int py, int walk_step, int view_dx, int view_dy, boolean showMaze, boolean showSolution) {
        ...
        for (int y = ymin; y <= ymax; y++)
            for (int x = xmin; x <= xmax; x++) {
                ...
                mp.setColor(seencells.hasWall(x,y, CardinalDirection.North) ? edu.wm.cs.cs301.amazebyminaandwils.falstad.MazePanel.ColorEnum.WHITE : edu.wm.cs.cs301.amazebyminaandwils.falstad.MazePanel.ColorEnum.GRAY);
                ...
                mp.setColor(seencells.hasWall(x,y, CardinalDirection.West) ? edu.wm.cs.cs301.amazebyminaandwils.falstad.MazePanel.ColorEnum.WHITE : edu.wm.cs.cs301.amazebyminaandwils.falstad.MazePanel.ColorEnum.GRAY);
    ...
    public void draw_currentlocation(MazePanel mp, int view_dx, int view_dy) {
        mp.setColor(edu.wm.cs.cs301.amazebyminaandwils.falstad.MazePanel.ColorEnum.RED);
    ...
    public void draw_solution(MazePanel mp, int offx, int offy, int px, int py) {
        ...
        mp.setColor(edu.wm.cs.cs301.amazebyminaandwils.falstad.MazePanel.ColorEnum.YELLOW);
