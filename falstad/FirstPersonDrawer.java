...
public class FirstPersonDrawer extends DefaultViewer {
    ...
    private static final String TAG = ":FirstPersonDrawerLOG:";
     ...
     */
    @Override
    public void redraw(/*Graphics gc*/ MazePanel mp, StateGUI state, int px, int py, int view_dx, int view_dy, int walk_step, int view_offset, RangeSet rset, int ang) {
...
//        this.mp = app.getPanel();
        this.mp = (MazePanel) mp;
        this.rset = rset ;
    ...
    private void drawBackground(MazePanel mp) {
        ...
        mp.setColor(edu.wm.cs.cs301.amazebyminaandwils.falstad.MazePanel.ColorEnum.DARKGRAY);
        mp.fillRect(0, view_height/2, view_width, view_height/2);
    }
    /**
